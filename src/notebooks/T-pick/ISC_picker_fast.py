...
from utils.physics.bathymetry.bathymetry_grid import BathymetryModel
        ...
        for year in [2014, 2013, 2012, 2011, 2010, 2009]:
            ...
            while idx < len(to_process):
                ...
                for i, r in tqdm(enumerate(res), desc="processing model output"):
                    ...
                    detections[ID].append((station.light_copy(), time, batch_PSDs[i], tissnet_peaks, np.max(bathy_profile)))
